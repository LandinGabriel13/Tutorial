...
----------- COVEREDBY (A,B) -----------
-- CoveredBy es el inverso de Covers.
-- ¿Cuántas manzanas de la Ciudad de México tienen menos de 1000 habitantes?, en este caso se seleccionará aquellas manzanas 
-- que tienen menos de 1000 habitantes que esten dentro de la Ciudad de México.
...
-- se hace uso de la  función coalesce para considerar valores nulos en caso de que existiesen.
...
-- En esta consulta se realiza una selección de los agebs que intersectan con el mayor número de papelerías, esto realiza mediante  
-- un conteo del código de actividad, se presenta con un orden descendente.
